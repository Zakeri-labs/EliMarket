...
import { ChevronLeft, MapPin, Pencil, Star, Trash2 } from "lucide-react";
import {
  createAddressAction,
  deleteAddressAction,
  updateAddressAction,
...
export default function AddressesPage() {
  ...
  if (status !== "authenticated") {
    return (
      <main className="py-4 md:mx-auto md:max-w-md md:py-6" dir={dir}>
...
function AddressesPageContent() {
  ...
  return (
    <main className="py-4 md:mx-auto md:max-w-md md:py-6" dir={dir}>
      ...
      {formOpen ? (
        <form
          className="mt-4 grid gap-2 rounded-2xl border border-border bg-surface p-4"
          onSubmit={(e) => {
            e.preventDefault();
            const payload = {
              label,
        ...
        <Button type="button" variant="outline" fullWidth className="mt-4" onClick={startNew}>
